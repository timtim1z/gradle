...
public class GradleDocsAsciidoctorExtensionRegistry implements ExtensionRegistry {
    ...
    public void register(Asciidoctor asciidoctor) {
        ...
        registry.docinfoProcessor(new GradleFlairDocinfoProcessor());
        registry.postprocessor(new GradleNavigationInjectingPostprocessor());
        Map<String, Object> options = new HashMap<String, Object>();
        options.put("location", ":footer");
        registry.docinfoProcessor(new GradleAfterFooterContentDocinfoProcessor(options));
    }
}
