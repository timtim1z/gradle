...
You can use the command line switches shown in <<logLevelCommandLineOptions>> to choose different log levels. You can also configure the log level using gradle.properties, <<buildEnvironment#sec:gradle_configuration_properties, see the section on Gradle configuration properties>>. In <<stacktraces>> you find the command line switches which affect stacktrace logging.
...
.init.gradle
----
include::../../samples/userguide/initScripts/customLogger/init.gradle[]
----
[source.multi-language-sample,kotlin]
.init.gradle.kts
----
include::../../samples/userguide/initScripts/customLogger_kts/init.gradle.kts[]
----

This shows the new logging with the above init script applied.

[source.multi-language-sample,groovy]
----
❯ gradle -I init.gradle build
include::../../samples/userguide/initScripts/customLogger/build.out[]
----
[source.multi-language-sample,kotlin]
----
❯ gradle -I init.gradle.kts build
include::../../samples/userguide/initScripts/customLogger_kts/build.out[]
----


Your logger can implement any of the listener interfaces listed below. When you register a logger, only the logging for the interfaces that it implements is replaced. Logging for the other interfaces is left untouched. You can find out more about the listener interfaces in <<buildLifecycle#build_lifecycle_events, the section on build lifecycle events>>.

* link:../javadoc/org/gradle/BuildListener.html[BuildListener]
* link:../javadoc/org/gradle/api/ProjectEvaluationListener.html[ProjectEvaluationListener]
* link:../javadoc/org/gradle/api/execution/TaskExecutionGraphListener.html[TaskExecutionGraphListener]
* link:../javadoc/org/gradle/api/execution/TaskExecutionListener.html[TaskExecutionListener]
* link:../javadoc/org/gradle/api/execution/TaskActionListener.html[TaskActionListener]
